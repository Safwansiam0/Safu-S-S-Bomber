...
Creator :Safwan Ahammed Siam 
GITHUB    : Safu-King1haker
VERSION   : 5.0
PROJECT   : SMS BOMBER 
FACEBOOK  : Safwan Ahammed Siam 
×××××××××××××××××××××××××××××××××××××××××××"""
  for i in logo:
    sys.stdout.write(i)
    sys.stdout.flush()
...
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER :Safwan Ahammed Siam
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ GITHUB    : Safu-King1haker
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ VERSION   : 5.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : Safwan Ahammed Siam 
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
